...
describe('components/Token/DismissButton', () => {
  ...
  it('should render `Button`', () => {
    ...
    expect(component.find('Memo(ButtonIcon)').length).toBe(1);
  });
  ...
  it('should pass test section to `Button`', () => {
    ...
    expect(component.find('Memo(ButtonIcon)').props().testSection).toBe('goose-dismiss');
  });
  ...
  it('should pass `onClick` to `Button`', () => {
    ...
    expect(component.find('Memo(ButtonIcon)').props().onClick).toBe(myFunc);
  });
});
