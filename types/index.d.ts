...
declare module 'optimizely-oui' {
  ...
  export { default as DragAndDrop } from 'components/DragAndDrop/index';
...
declare module "components/CodeDiff/CodeDiff" {
    export function CodeDiff(props: any): JSX.Element;
    export namespace CodeDiff {
        export namespace propTypes {
            export const borderLocation: PropTypes.Requireable<(string | null | undefined)[]>;
            export const header: PropTypes.Requireable<PropTypes.ReactNodeLike>;
            export const newValue: PropTypes.Validator<any>;
            export const oldValue: PropTypes.Validator<any>;
            export const testSection: PropTypes.Requireable<string>;
        }
        export namespace defaultProps {
            const borderLocation_1: string[];
            export { borderLocation_1 as borderLocation };
            export const compareMethod: string;
...
declare module "utils/storybook-utils" {
    /**
     ...
     */
    export function StoryStateWrapper({ children, initialValue, initialValues }: any): any;
    export namespace StoryStateWrapper {
        export namespace propTypes {
            export const initialValue: PropTypes.Requireable<any>;
            export const initialValues: PropTypes.Requireable<any[]>;
        }
        export namespace defaultProps {
            const initialValue_1: null;
            export { initialValue_1 as initialValue };
            const initialValues_1: null;
...
declare module "components/Form/Row/index" {
    import PropTypes from 'prop-types';
    const Row: {
...
declare module "components/Form/Item/index" {
    import PropTypes from 'prop-types';
    const Item: {
        (props: any): JSX.Element;
        propTypes: {
...
declare module "components/Fieldset/index" {
    ...
    const Fieldset: {
        ...
        propTypes: {
            ...
            bottomSpacing: PropTypes.Requireable<boolean>;
...
declare module "components/Dropdown/index" {
    ...
    namespace Dropdown {
        ...
        export namespace propTypes {
            ...
            export const buttonContent: PropTypes.Requireable<string | PropTypes.ReactElementLike | PropTypes.InferProps<{
...
declare module "components/SearchPicker/index" {
    export default SearchPicker;
    class SearchPicker extends React.Component<any, any, any> {
        static propTypes: {
            /**
             ...
             * via @keyboardTracker
             */
            keyboardRef: PropTypes.Requireable<PropTypes.InferProps<{
                current: PropTypes.Requireable<PropTypes.ReactComponentLike>;
            }>>;
            /**
             * Handler to call when an item is selected via the keyboard.
             */
            onItemSelected: PropTypes.Validator<(...args: any[]) => any>;
            /**
             ...
             * @return {Promise}
             */
            searchFunction: PropTypes.Validator<(...args: any[]) => any>;
            /**
        ...
        state: {
            currentSearch: null;
            defaultResults: never[];
            isLoading: boolean;
            results: null;
            searchQuery: string;
        };
        handleItemSelected: (index: any) => void;
        /**
         ...
         */
        handleOnInput: (event: React.SyntheticEvent<Element, Event>) => void;
        /**
         ...
         */
        executeNewSearch: (query: string) => Promise<any[]>;
        /**
         ...
         */
        renderInput: (props?: any) => React.Component<any, any, any>;
        /**
         * A simple render method that passes relevant state and controls to the
         * children.
         * @returns {React.Component}
         */
        render(): React.Component<any, any, any>;
    }
    import React from "react";
    import PropTypes from "prop-types";
}
declare module "components/SearchPicker/mock_api/mock_data" {
    var _default: ({
        id: number;
        name: string;
        type: string;
...
declare module "components/SearchPicker/mock_api/index" {
    export function getSearchFunction(DELAY?: number): ({ query, per_page }: {
        query: any;
        per_page: any;
    }) => Promise<({
        id: number;
...
declare module "components/SearchPicker/SearchPicker.story" {
    export {};
}
